document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateField(field) {
    ...
    if (field.hasAttribute('minlength') && value.length < parseInt(field.getAttribute('minlength'), 10)) {
      showFieldError(field, fieldLabel + ' must be at least ' + field.getAttribute('minlength') + ' characters.');
      return false;
    }

    if (field.hasAttribute('maxlength') && value.length > parseInt(field.getAttribute('maxlength'), 10)) {
      showFieldError(field, fieldLabel + ' must be no more than ' + field.getAttribute('maxlength') + ' characters.');
      return false;
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd050f485-2e3a-45f0-9866-d51f1ecbf8d2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd050f485-2e3a-45f0-9866-d51f1ecbf8d2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd050f485-2e3a-45f0-9866-d51f1ecbf8d2';
